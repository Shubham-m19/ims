...
@Component({
  selector: 'app-po-report-page',
  templateUrl: './po-report-page.component.html',
  styleUrls: ['./po-report-page.component.css']
})
export class PoReportPageComponent implements OnInit {
  // Filters
  yearFilter: string = '';
  headFilter: string = '';
  schoolFilter: string = '';
